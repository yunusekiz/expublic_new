...
class contact extends CI_Controller {
	...
	public function updateContact()
	{
		...
		if(($facebook=='')||($twitter=='')||($g_plus=='')||($skype=='')||($address_field == '')||($phone_field == '')||($email_field == ''))
		{
		...
		{
			$update = $this->contact_model->updateRow($facebook,$twitter,$g_plus,$skype,$address_field,$phone_field, $email_field);
			if($update == TRUE)
			{
