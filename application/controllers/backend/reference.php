...
class reference extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->model_name = 'reference_model';
	...
	public function updateItemDetailForm($id = 1)
	{
		$this->parser_data['item_detail'] = $this->{$this->model_name}->readRow($id);
		
		$this->parser->parse('backend_views/admin_header_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_main_view',$this->parser_data);
		$this->parser->parse('backend_views/update_reference_detail_view',$this->parser_data);
	...
	public function updateItemDetail()
	{
		...
		if ($reference_detail!='') 
		{
			$update_item_detail = $this->{$this->model_name}->updateItemDetail($reference_detail);
