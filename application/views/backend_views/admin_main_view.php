		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					...
					<ul>
						<li><a href="{base}backend/headline/editItemForm" class="{big_slider_current}">Manşeti Düzenle </a></li>																
					</ul>
				...
				<li> 
					...
					<ul>
						<li><a href="{base}backend/service/addItemForm" class="{add_ref_current}">Yeni Kayıt Ekle</a></li>
						<li><a href="{base}backend/service/allItems" class="{edit_ref_current}">Kayıtları Düzenle/Sil</a></li> <!-- Add class "current" to sub menu items also -->
					</ul>
				</li>
