						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="{backend_base}slider/changeItemPhotoForm/{slider_id}/{photo_id}" title="Fotoğraf Yükle"><img src="{base}assets/backend_assets/images/icons/up_2.png" alt="Fotoğraf Yükle" /></a>
									</td>

									<td class="cocukdiv_image">
										<a href="{base}{slider_big_photo}">
