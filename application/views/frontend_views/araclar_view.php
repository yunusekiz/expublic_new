...
<section class="wrapper clearfix">
    ...
    <section class="content clearfix">  
        <div class="content-inner container">
        	<h3 class="big-text">ARA&Ccedil;LARIMIZ</h3>
            
            <!--PORTFOLIO FILTER-->
            <ul class="port-filter clearfix">
                <li><a data-filter="*" href="#">HEPSİ</a></li>
                {brand_iteration}
                <li><a data-filter=".{brand_css}" href="#">{brand_name}</a></li>
                {/brand_iteration}
            </ul>
            ...
            <div class="row portfolio-body">
                {auto_iteration}
                <div class="span3 {brand_css} content-inner">
...
<!--                     	<i class="icon-coffee work-icon"></i> -->
...
<!--         <div class="content-inner port-pager container">
    ...
    <script type="text/javascript" src="{base}js/portfolio.js"></script>
